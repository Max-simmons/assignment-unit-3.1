...
let favoriteFoods = ['steak', 'crab', 'donuts', 'ribs'];
...
console.log('The second food is', favoriteFoods[1])

// 3.b. TODO: Log the last animal in the array using it's array index 
console.log('The last food is', favoriteFoods[3])
...
console.log('Added Mac + Cheese to end', favoriteFoods);
